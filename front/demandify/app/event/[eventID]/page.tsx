...
export default function EventPage({ params }: { params: { eventID: string } }) {
  ...
  return <div className="px-48 pt-24 w-screen min-h-screen bg-white">
    ...
    <div className="flex flex-row items-end gap-12 h-full pt-12">
      <div className="flex flex-col w-1/2 h-full">
        <Image  
      ...
      <div className="flex flex-col w-1/2 h-full gap-4">
        <p className="text-black">TODO here display visually some business-important numbers that can go up</p>
        <div className="text-black">Rating here</div>
